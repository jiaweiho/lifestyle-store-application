...
Router.post('/signup', async (req, res) => {
  try {
    ...
    console.log('InvalidCheck' + isInvalidFieldProvided);
    ...
    const result = await pool.query(
      'select count(*) as count from store_user where email=$1',
      [email]
    );
    ...
    console.log('Hash done' + hashedPassword);
    await pool.query(
      'insert into store_user(first_name, last_name, email, password) values($1,$2,$3,$4)',
